...
public class WWM_Main extends Activity implements OnClickListener {
	GPSTracker gps;
	Updator updates;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.wwm_main);
		ActionBar actionBar = (ActionBar) findViewById(R.id.actionbar);
		// You can also assign the title programmatically by passing a
		// CharSequence or resource id.
		// actionBar.setTitle(R.string.some_title);

		actionBar.setTitle("					Waste Water Management");
	...
	private void findviewbyid() {
		// TODO Auto-generated method stub
		but = (Button) findViewById(R.id.bWWM);
	...
	public void onClick(View arg0) {
		...
		case R.id.bPassword:
			try {
				...
				Intent ourIntent = new Intent(WWM_Main.this, ourClass);
